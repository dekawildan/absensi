    ...
    <aside id="aside">
        <nav>
            <ul>
                ...
                <li><a href="absen-pulang.php" class="aktif">Absen Pulang</a></li>
                        ...
                        if(isset($_POST['cari'])) {
                            ...
                            while($cek=mysqli_fetch_array($sqlcarisiswa)) {
                                ...
                                if(mysqli_num_rows($cekjumlah) < 1) {
                                    echo "<div class='alert alert-warning'>Maaf data siswa tidak ditemukan</div>";
                                } else {
                                    $waktu=date('H:i:s');
                                    if($waktu<='11:00:00') {
                                        echo "<div class='alert alert-danger' data-bs-dismiss='alert'>
                                            Maaf, belum boleh absen pulang
                                    ...
                                    $nis=$cek['siswa_nis'];
                                    $status="Pulang";
                                    $sqlcekmasuk=mysqli_query($koneksi, "CALL cek_absen('$nis','$tglskr')");
                                    if(mysqli_num_rows($sqlcekmasuk) < 1) {
                                        echo "<div class='alert alert-danger' data-bs-dismiss='alert'>
                                        Maaf, nis belum absen masuk hari ini
                                        <button class='btn btn-close close' data-bs-dismiss='alert'></button>
                                        </div>";
                                    } else {
                                    include "koneksi.php";
                                    $sqlcek=mysqli_query($koneksi, "CALL cek_absen_pulang('$nis','$tglskr')");
            ...
            <p>&nbsp;
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <?php
                            include "koneksi.php";
                                $sql=mysqli_query($koneksi,"CALL tampil_absen_pulang()");
                                $no=1;
                ...
                <div class='modal-dialog'>
                    <div class='modal-content'>
                        ...
                        <div class='modal-body'>
                            <form method='post' action='hapus_absen_pulang.php'>
